...
// class SInventoryContainer : public SBorder 
// {
// public:
...
//                        .BorderImage(this, &SInventoryContainer::GetImage));
//     Style = InArgs._Style;
//   }
...
//     SBorder::OnPaint(Args, AllottedGeometry, MyCullingRect, OutDrawElements, LayerId, InWidgetStyle, ShouldBeEnabled( bParentEnabled ));

//     static const FSlateBrush* SlotBorder = FInventoryEditorStyle::Get()->GetBrush("InventoryEditor.SlotBorder");
//     static const FSlateBrush* SlotHover = FInventoryEditorStyle::Get()->GetBrush("InventoryEditor.SlotHover");

//     if (!EditorPtr.IsValid()) return LayerId;

//     if (SlotHovered >= 0) {
//       FSlateDrawElement::MakeBox(OutDrawElements, LayerId,
//                                  AllottedGeometry.ToPaintGeometry(Style->SlotStartPosition[SlotHovered],
...
//       FSlateDrawElement::MakeBox(OutDrawElements, LayerId,
//                                  AllottedGeometry.ToPaintGeometry(Style->SlotArrayStartPosition[ArrayHovered] + size * FVector2D(ColHovered, RowHovered),
//                                                                   size),
//                                  SlotHover,
//                                  ESlateDrawEffect::None,
//                                  FLinearColor(1.0f, 1.0f, 1.0f, 0.7f));
...
//     if (EditorPtr.Pin()->ShowSlots) {
//       if (UInventorySimple* inventory = EditorPtr.Pin()->Inventory) {
//         for (int32 i = 0; i < FMath::Min(Style->SlotStartPosition.Num(), Style->SlotSize.Num()); i++) {
//           FSlateDrawElement::MakeBox(OutDrawElements,
//                                      LayerId,
//                                      AllottedGeometry.ToPaintGeometry(Style->SlotStartPosition[i],
//                                                                       Style->SlotSize[i]),
//                                      SlotBorder,
//                                      ESlateDrawEffect::None,
//                                      FLinearColor(0.0f, 1.0f, 0.0f, 0.7f)
...
//     if (!EditorPtr.IsValid()) return FReply::Unhandled();

//     UInventorySimple* inventory = EditorPtr.Pin()->Inventory;
//     if (!inventory) return FReply::Unhandled();
...
//       if (gridPosition.X >= 0 && gridPosition.X < inventory->SlotArrays[i]->Width &&
//           gridPosition.Y >= 0 && gridPosition.Y < inventory->SlotArrays[i]->Height) {
...
//   // TODO: Render Items
// protected:
//   const FInventoryStyleSimple* Style;
//   TWeakPtr<FInventorySimpleEditor> EditorPtr;
